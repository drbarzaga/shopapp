...
@section('breadcrumb')
  <a href="javascript:;" class="current">Campos de productos</a>
@endsection
  ...
  <div id="addField" class="modal hide" data-keyboard="false" data-backdrop="static">
    ...
    <div class="modal-body">
      <form enctype="multipart/form-data" class="form-horizontal" id="fieldForm">
        ...
        <input type="hidden" id="urlCreate" value="{{route('api_product_field_create')}}">
      </form>
...
@section('js')
  ...
  <script src="{{asset('backend/scripts/productField.js')}}"></script>
  <script>
